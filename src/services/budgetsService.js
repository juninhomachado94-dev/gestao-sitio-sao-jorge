...
export const budgetTemplates = [
  {
    ...
    name: "Pacote Básico",
    items: [
      createBudgetItem({ name: "Locação do sítio", quantity: 1, unitPrice: 800, unitCost: 250 }),
      createBudgetItem({ name: "Piscina", quantity: 1, unitPrice: 0, unitCost: 0 }),
      createBudgetItem({ name: "Churrasqueira", quantity: 1, unitPrice: 0, unitCost: 0 }),
    ],
  },
  {
    id: "completo",
    ...
    items: [
      createBudgetItem({ name: "Locação do sítio", quantity: 1, unitPrice: 1100, unitCost: 300 }),
      createBudgetItem({ name: "Piscina", quantity: 1, unitPrice: 0, unitCost: 0 }),
      createBudgetItem({ name: "Churrasqueira", quantity: 1, unitPrice: 0, unitCost: 0 }),
      createBudgetItem({ name: "Taxa de limpeza", quantity: 1, unitPrice: 150, unitCost: 100 }),
    ],
  },
  {
    id: "premium",
    ...
    items: [
      createBudgetItem({ name: "Locação do sítio", quantity: 1, unitPrice: 1500, unitCost: 420 }),
      createBudgetItem({ name: "Piscina", quantity: 1, unitPrice: 0, unitCost: 0 }),
      createBudgetItem({ name: "Churrasqueira", quantity: 1, unitPrice: 0, unitCost: 0 }),
      createBudgetItem({ name: "Área de lazer", quantity: 1, unitPrice: 0, unitCost: 0 }),
      createBudgetItem({ name: "Taxa de limpeza", quantity: 1, unitPrice: 150, unitCost: 100 }),
      createBudgetItem({ name: "Hora extra", quantity: 1, unitPrice: 120, unitCost: 0 }),
    ],
  },
  {
    id: "personalizado",
    name: "Pacote Personalizado",
    items: [createBudgetItem({ name: "Locação do sítio", quantity: 1, unitPrice: 0, unitCost: 0 })],
  },
];
...
export function createEmptyBudget() {
  return normalizeBudget({
    ...
    eventType: "",
    peopleCount: "",
    items: [createBudgetItem({ name: "Locação do sítio" })],
    discountValue: 0,
    discountPercent: 0,
    depositValue: 0,
    validityDays: 3,
